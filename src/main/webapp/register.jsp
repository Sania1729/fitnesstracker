...
<body>
	...
	<div class="register-card">
		...
		<h3 class="brand-title">Create Your Account</h3>

		<%
		if (request.getParameter("error") != null) {
		%>

		<div class="alert alert-danger">Registration failed! Please try
			again.</div>
		...
		<form action="register" method="post">
			...
			<div class="mb-3">
				...
				<div class="input-group">
					...
					<span class="input-group-text" onclick="togglePassword()"
						style="cursor: pointer"> <i class="fas fa-eye" id="eyeIcon"></i>
			...
			<div class="mb-3">
				...
				<div class="input-group">
					...
					<span class="input-group-text"> <i class="fas fa-user-tag"></i>
					</span> <select class="form-control" name="role" required>
			...
			<div class="mb-3">
				...
				<div class="input-group">
					...
					</span> <input type="tel" class="form-control" name="phone"
